            ...
            for c in range(6):
                for d in range(6):
                    for e in range(6):
                        ...
                        eyes=Image.open(("Layers/eye/eye{}.png".format(c))).convert("RGBA")
                        ...
                        count += 1
def showOut():
    print("Started to show")
    time.sleep(10)
    print("Now showing")
    fPath = "showimg.py"
    args = '"%s" "%s" "%s"' % (sys.executable, fPath, os.path.basename(fPath))
